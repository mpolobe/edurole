...
$fullname['ldap']['staffou'] = array("Organisational unit for staff", "text"); 
$fullname['ldap']['adminou'] = array("Organisational unit for admins", "text"); 

$fullname['mail']['server'] = array("IMAP server IP", "text");  
$fullname['mail']['port'] = array("IMAP port", "text"); 
?>
