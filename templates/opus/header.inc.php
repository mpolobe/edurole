<?php
global $pagename, $jsconflict, $home, $conf;
...
<title>'.$conf['conf']['titlename'].'</title>
...
if(!isset($home)){
	echo'  <div class="headercenter"><a href="."><img src="templates/edurole/images/header.png" /></a></div>
		<div class="bodycontainer">';
}

if(isset($_SESSION['access'])){ eduroleCore::viewMenu();	};
