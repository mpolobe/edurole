...
<link href="<? echo $this->core->conf['conf']['path']; ?>/templates/bootstrap/css/sb-admin.css" rel="stylesheet">
<link href="<? echo $this->core->conf['conf']['path']; ?>/templates/bootstrap/css/bootstrap.css" rel="stylesheet">
...
?>
    ...
    <script src="<? echo $this->core->conf['conf']['path']; ?>/lib/bootstrap/bootstrap.js"></script>
...
<body>
	...
	<div class="navbar-fixed-top header" >
		<a href="<? echo $this->core->conf['conf']['path']; ?>"><img src="<? echo $this->core->fullTemplatePath; ?>/images/header.png" /></a>
	</div>
