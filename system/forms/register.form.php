...
<tr>
	...
	<td>
		<input type="text" name="celphone"/></td>
	<td>&nbsp;</td>
</tr>
<tr>
...
<p>In this section you can provide contact information that should be used in case of an emergency, in general this
	should be a family member or legal guardian. Use the add button to add as many emergency contacts as you wish.</p>
<div>
	<div id="contact-element">
		<input type="hidden" name="econtact[#index][id]"/>
		<table cellspacing="0">
			<tr>
				<td>
					<table width="768" height="135" border="0" cellpadding="5" cellspacing="0">
						<tr>
							...
							<td bgcolor="#EEEEEE"><strong>
									<div class="delete-contact link"><a href="#">Remove section</a></div>
								</strong></td>
						</tr>
						<tr>
							<td height="19"><strong>Full Name</strong></td>
							<td>
								<input type="text" name="econtact[#index][fullname]"/></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td height="19"><strong>Relationship</strong></td>
							<td>
								<select name="econtact[#index][relationship]" id="spouse">
						...
						<tr>
							...
							<td>
								<input type="text" name="econtact[#index][phonenumber]"/></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td height="22"><strong>Street</strong></td>
							<td>
								<input type="text" name="econtact[#index][street]"/></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td height="22"><strong>Town</strong></td>
							<td><input type="text" name="econtact[#index][town]"/></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td height="22"><strong>Postalcode</strong></td>
							<td><input type="text" name="econtact[#index][postalcode]"/></td>
							<td>&nbsp;</td>
						</tr>
					</table>
				</td>
...
<p>In this section you will need to provide records of your previously followed education (secondary education and up),
	you can use the Add button below this section to add more then one record, please enter as many records as
	needed.</p>
<div>
	<div id="education-element" class="expandable-form-entry">
				...
				<td>
					<table width="768" height="94" border="0" cellpadding="5" cellspacing="0">
						...
						<tr>
							...
							<td>
								<select name="education[#index][type]" id="education">
						...
						<tr>
							...
							<td>
								<input type="text" name="education[#index][institution]"/></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td height="22"><strong>Name of certification</strong></td>
							<td>
								<input type="text" name="education[#index][name]"/></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td height="22"><strong>Scan of document</strong></td>
							<td>
								<input type="file" name="education[#index][upload]"/></td>
...
<p>&nbsp;</p>
<h2><strong>Program enrollment</strong></h2>
<p>This is the final part of your admission request, here you will need to select the program you wish to minor and
	major in.</p>
<div>

	<table width="0" cellspacing="0">
		<tr>
			<td>
				<table width="768" height="94" border="0" cellpadding="5" cellspacing="0">
					<tr>
...
<h2><strong>Submit your application</strong></h2>
