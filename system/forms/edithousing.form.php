...
<form id="edithousing" name="edithousing" method="post" action="<?php echo $this->core->conf['conf']['path'] . "/housing/save/" . $this->core->item; ?>">
	...
	<input type="submit" class="submit" name="submit" id="submit" value="Save housing" />
	<p>&nbsp;</p>
