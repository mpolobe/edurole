<form id="recover" name="recover" method="post" action="">
	...
	<table width="700" border="0" cellpadding="5" cellspacing="0">
		...
		<tr>
			<td><img id="captcha" src="<? echo $this->core->conf['conf']['libPath']; ?>/secureimage/securimage_show.php" alt="CAPTCHA Image"/></td>
	...
	<p>Click on the button to complete your password recovery request. </p>
