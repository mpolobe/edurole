...
$conf['mysql']['user'] = "mysqluser"; 											// MySQL user
$conf['mysql']['password'] = "mysqlpassword"; 									// MySQL password
 ...
 */
$conf['conf']['templates'] = array("edurole", "example", "KCE", "example"); 								// Template names in array form
