...
class files {
	...
	function viewPersonalFiles($path) {
		...
		echo	'<div class="toolbar">
			<a href="' . $this->core->conf['conf']['path'] . '/files/upload/' . $path . '"><img src="' . $this->core->fullTemplatePath . '/images/up.png"/>  upload a file</a>
			<a href="' . $this->core->conf['conf']['path'] . '/files/new/' . $path . '"><img src="' . $this->core->fullTemplatePath . '/images/list.gif"/> create an empty file</a>
			<a href="' . $this->core->conf['conf']['path'] . '/files/makedir/' . $path . '"><img src="' . $this->core->fullTemplatePath . '/images/new.gif"/> new directory</a>
			</div>';
