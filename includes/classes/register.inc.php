...
$firstname 	= $this->core->$cleanPost["firstname"];         $middlename 	= $this->core->$cleanPost["middlename"];
$surname 	= $this->core->$cleanPost["surname"];           $sex 		= $this->core->$cleanPost["sex"];
$id 		= $this->core->$cleanPost["studentid"];         $day 		= $this->core->$cleanPost["day"];
$month          = $this->core->$cleanPost["month"];		$year           = $this->core->$cleanPost["year"];
$pob 		= $this->core->$cleanPost["pob"];		$nationality    = $this->core->$cleanPost["nationality"];
$streetname 	= $this->core->$cleanPost["streetname"];	$postalcode 	= $this->core->$cleanPost["postalcode"];
$town 		= $this->core->$cleanPost["town"];		$country 	= $this->core->$cleanPost["country"];
$homephone 	= $this->core->$cleanPost["homephone"];         $celphone 	= $this->core->$cleanPost["celphone"];			
$dissability 	= $this->core->$cleanPost["dissability"];	$mstatus 	= $this->core->$cleanPost["mstatus"];			
$studytype 	= $this->core->$cleanPost["studytype"];         $email          = $this->core->$cleanPost["email"];
$distype 	= $this->core->$cleanPost["dissabilitytype"];   $hostel 	= $this->core->$cleanPost["hostel"];
$payment 	= $this->core->$cleanPost["payment"];           $receiptnr 	= $this->core->$cleanPost["receiptnr"];
