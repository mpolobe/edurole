...
class grades{
    ...
    function gradebook(){
            ...
            while ($fetch = $run->fetch_row()) {
                    ...
                    $grade = $fetch[3];		$studentno = $fetch[8];
                    $courseid = $fetch[9];	$coursename = $fetch[11];
                    $batchname = $fetch[8];	$date = $fetch[4];
    ...
    function viewOwn(){
            ...
            while ($fetch = $run->fetch_row()) {
                    ...
                    $validator = $fetch[6];	$firstname = $fetch[11];
                    $lastname = $fetch[13];	$studentno = $fetch[8];
                    $courseid = $fetch[7];	$coursename = $fetch[9];
                    $batchname = $fetch[8];	$date = $fetch[4];
                    $uid = $fetch[10];		
