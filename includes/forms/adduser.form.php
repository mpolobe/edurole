...
<form id="adduser" name="adduser" method="post" action="?id=users&action=save">
          ...
          <tr>
            <td><table width="768" height="465" border="0" cellpadding="5" cellspacing="0">
              ...
              <tr>
                ...
                <td>Username for user to login</td>
              </tr>
              <tr>
			...
			<?php echo $select; ?>
              ...
              <tr>
                ...
                <td>  <div id="status"></div> Please enter the ID number provided on your NRC</td>
              </tr>
              <tr>
	...
	<option value="1900">1900</option>
		 ...
		 <input name="otherdissability" type="text" id="textfield4949"  value=""/>
		</td>
                <td><br />
Use field to specify in case dissability is not listed</td>
              </tr>
              <tr>
	  ...
	  <input type="submit" class="register" name="submit-registrar" id="submit-registrar" value="Create user account" />
        <p>&nbsp;</p>
