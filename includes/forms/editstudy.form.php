...
function showSchools($school){
	...
	while($fetch = mysql_fetch_row($run)){
		...
		$name	= $fetch[1];
		$uid 	= $fetch[0];
		if($uid == $school){ $sel = 'selected="selected"'; } else { $sel=""; } 
...
$select = showSchools($school);
	...
	<option value="0" '; if($fetch[4]=="3"){ echo'selected=""'; } echo'>-choose-</option>
	<option value="3" '; if($fetch[4]=="3"){ echo'selected=""'; } echo'>Distance learning</option>
	<option value="2" '; if($fetch[4]=="2"){ echo'selected=""'; } echo'>Parallel programme</option>
	<option value="1" '; if($fetch[4]=="1"){ echo'selected=""'; } echo'>Regular programme</option>
	<option value="4" '; if($fetch[4]=="4"){ echo'selected=""'; } echo'>Various forms</option>
	...
	<option value="0" '; if($fetch[11]=="0"){ echo'selected=""'; } echo'>Part-time</option>
	<option value="1" '; if($fetch[11]=="1"){ echo'selected=""'; } echo'>Fulltime</option>
	...
	<option value="12" '; if($fetch[10]=="12"){ echo'selected=""'; } echo'>1 Year</option>
	<option value="24" '; if($fetch[10]=="24"){ echo'selected=""'; } echo'>2 Years</option>
	<option value="36" '; if($fetch[10]=="36"){ echo'selected=""'; } echo'>3 Years</option>
	<option value="48" '; if($fetch[10]=="48"){ echo'selected=""'; } echo'>4 Years</option>
	<option value="60" '; if($fetch[10]=="60"){ echo'selected=""'; } echo'>5 Years</option>
	<option value="72" '; if($fetch[10]=="72"){ echo'selected=""'; } echo'>6 Years</option>
	</select>
	</td>
	<td></td>
	</tr>
