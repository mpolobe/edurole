          ...
          <tr>
            <td><table width="768" height="465" border="0" cellpadding="5" cellspacing="0">
              ...
              <tr>
                ...
                <td>  <div id="status"></div> Please enter the ID number provided on your national identification card or passport</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td> <div style="float:left;"><select name="day" id="day">
                ...
                </select></div><div style="float:left;"><select name="month"  id="month" >
                ...
                </select></div><div style="float:left;"><select name="year" id="year">
	<option> Year </option>
	...
	<p>In this section you can provide contact information that should be used in case of an emergency, in general this should be a family member or legal guardian. Use the add button to add as many emergency contacts as you wish.</p>
        ...
        <table	 cellspacing="0">
          <tr>
            <td><table width="768" height="135" border="0" cellpadding="5" cellspacing="0">
              <tr>
	...
	<p>In this section you will need to provide records of your previously followed education (secondary education and up), you can use the Add button below this section to add more then one record, please enter as many records as needed.</p>
        ...
        <table width="200" 	 cellspacing="0">
          <tr>
            <td><table width="768" height="94" border="0" cellpadding="5" cellspacing="0">
              <tr>
                <td width="205" height="28" bgcolor="#EEEEEE"><strong>Fieldname</strong></td>
                <td width="200" bgcolor="#EEEEEE"><strong>Input field</strong></td>
                <td  bgcolor="#EEEEEE"><strong><div class="delete-contact link"><a href="#">Remove section</a></div></strong></td>
        ...
        <h3><strong><div id="add-education" class="link"><a href="#add-education"> <img src="templates/default/images/plus.png"   width="16" height="16"/> Add  education background</a></div></strong></h3>
