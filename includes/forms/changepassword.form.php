	<form id="recover" name="recover" method="post" action="password.php?id=recover">
			...
			<table width="700" border="0" cellpadding="5" cellspacing="0">
            		  ...
            		  <tr>
            		    ...
            		    <td>Please enter the text in the verification image, if you are having difficulty reading the text please click <a href="#" onclick="document.getElementById('captcha').src = 'lib/secureimage/securimage_show.php?' + Math.random(); return false">here.</a></td>
           		   </tr>
			</table>
